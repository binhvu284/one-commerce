...
const PROVIDERS: AIProvider[] = [
  ...
  },
  {
    ...
    type: 'llm',
    logo: (
      <svg viewBox="0 0 256 256" className="w-6 h-6"><path d="M141.201 4.886C140.75.148 134.1-.148 133.25 4.886c-7.573 20.629-2.241 6.105-10.869 6.121C11.127 113.049 4.801 184.001 0 0c0 111.257 6.143 2.227 6.156 10.91 13.155 1.935 7.082 18.004 0 0 0 0-109.495 109.385c-7.573 20.629-2.241 6.105-10.869 6.121-13.133 25.1-7.908-21.296 184 0 0-109.02-108.658L19.698-7.239c-6.102-2.243-6.118-10.867-.025-13.132 120.083-7.467A183.998 183.998 0 0 0 133.291 26.281l7.91-21.394z" fill="url(#gemini_gradient)"/><defs><linearGradient id="gemini_gradient" x1="1.439" y1="131.547" x2="253.303" y2="131.547" gradientUnits="userSpaceOnUse"><stop stop-color="#4e82ee"/><stop offset=".5" stop-color="#b03bef"/><stop offset="1" stop-color="#e06267"/></linearGradient></defs></svg>
    ),
    color: 'blue',
