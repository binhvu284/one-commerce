  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-12 px-6 border-y border-slate-50 overflow-hidden bg-slate-50/30">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-around gap-12 opacity-40 grayscale group-hover:grayscale-0 transition-all">
      ...
      <section className="py-32 px-6 bg-slate-900 overflow-hidden relative">
         ...
         <div className="max-w-4xl mx-auto text-center relative z-10 space-y-12">
            <motion.div
               ...
               className="space-y-6"
            >
               <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none">Stay ahead of <br /> the <span className="text-rose-500">Curve.</span></h2>
               <p className="text-slate-400 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">Join 10,000+ fashion-forward individuals and get exclusive early access to our limited collection drops.</p>
            </motion.div>
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-600">No spam. Just pure excellence, delivered weekly.</p>
         </div>
      </section>
    </div>
  );
